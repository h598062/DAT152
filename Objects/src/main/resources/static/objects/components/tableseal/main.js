export default class extends HTMLElement {
    ...
    constructor() {
        ...
        this._seal = this._seal.bind(this);
        ...
        this._shadow.querySelector("#seal > button").addEventListener("click",() => { Object.seal(this._array) });
    }
    ...
    _createHTML() {
        ...
        const content = `
            <form>
                ...
                <fieldset id="seal">
                    <legend>Seal array</legend>
                    <button type="button">Seal Array</button>
                </fieldset>
            </form>
        `;
